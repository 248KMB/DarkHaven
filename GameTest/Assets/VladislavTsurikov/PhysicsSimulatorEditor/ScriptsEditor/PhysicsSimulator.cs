...
namespace VladislavTsurikov.PhysicsSimulatorEditor.ScriptsEditor
{
    ...
    public static class PhysicsSimulator
    {
        ...
        private static bool s_enablePermanentPhysics;
        ...
        public static void RegisterGameObject(SimulatedBody simulatedBody)
        {
            ...
            {
                GameObjectCollider.RemoveNode(simulatedBody.GameObject);
            ...
            if(s_disablePhysicsTimeMode == DisablePhysicsMode.ObjectTime)
            {
                if(PhysicsSimulatorPath.Settings.SimulatePhysics)
                {
                    EditorCoroutines.ScriptsEditor.EditorCoroutines.StartCoroutine(ObjectTimePhysicsSimulator.DisablePhysicsSupportWithDelay(PhysicsSimulatorPath.Settings.ObjectTime, simulatedBody), simulatedBody.GameObject);
                }
            }
        }
    }
